...
public class SearchByKeywordStory {
    ...
    @Test
    public void searching_by_keyword_raspberry_should_display_the_corresponding_article() {
        anna.is_the_home_page();
        anna.looks_for("raspberry");
        anna.should_see_definition("The plant Rubus idaeus.");
    }
