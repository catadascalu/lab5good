...
@UseTestDataFrom("src/test/resources/EmagTestDataFilterError.csv")
public class EmagFilterCommentByKeywordErrorDdt {
    ...
    public void searchByKeyword(){
        ...
        steps.should_see_comments_filter_error(getResult());
    }
